...
def get_icon_path():
    ...
    possible_paths = [
        Path(__file__).parent / "notepad_plus_pro.ico",
        Path.cwd() / "notepad_plus_pro.ico",
        Path(sys.executable).parent / "notepad_plus_pro.ico",
        Path.home() / ".notepad_plus_pro" / "notepad_plus_pro.ico",
    ]
