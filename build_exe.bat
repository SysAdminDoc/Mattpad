@echo off
REM ============================================================
REM Build Notepad Plus Pro as a Portable EXE
REM ============================================================

echo.
echo ========================================
echo  Notepad Plus Pro - Build Script
echo ========================================
echo.
...
if not exist "notepad_plus_pro.ico" (
    echo WARNING: notepad_plus_pro.ico not found
    echo Building without custom icon...
    set ICON_FLAG=
) else (
    echo Found: notepad_plus_pro.ico
    set ICON_FLAG=--icon=notepad_plus_pro.ico
)
...
pyinstaller --onefile --windowed --name "NotepadPlusPro" %ICON_FLAG% ^
...
if exist "notepad_plus_pro.ico" (
    copy notepad_plus_pro.ico dist\ >nul 2>&1
)
...
echo.
echo ========================================
echo  OUTPUT: dist\NotepadPlusPro.exe
echo ========================================
echo.
