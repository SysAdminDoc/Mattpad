#!/usr/bin/env python3
"""
Notepad Plus Pro - Professional-grade text editor
...
CACHE_DIR = Path.home() / ".notepad_plus_cache"
SETTINGS_FILE = Path.home() / ".notepad_plus_pro_settings.json"
...
class EditorSettings:
    ...
    github_path: str = "notepad_plus_sync"
...
class CloudSyncManager:
    ...
    def configure_github(self, token: str, repo: str, branch: str = "main", path: str = "notepad_plus_sync"):
    ...
    def _sync_to_gdrive(self, tab_data: TabData, content: str) -> Tuple[bool, str]:
        ...
        try:
            # Load credentials
            token_path = Path.home() / ".notepad_plus_gdrive_token.json"
...
class NotepadPlusPro(ctk.CTk):
    ...
    def _create_toolbar(self):
        """Create toolbar"""
        self.toolbar = ctk.CTkFrame(self, fg_color=THEME.bg_medium, height=44, corner_radius=0)
        ...
        for icon, tooltip, command in buttons:
            if icon is None:
                sep = ctk.CTkFrame(left_frame, width=1, height=24, fg_color=THEME.bg_light)
    ...
    def _create_main_layout(self):
        ...
        # Tab bar
        self.tab_bar = ctk.CTkFrame(self.editor_container, fg_color=THEME.tab_inactive, height=38, corner_radius=0)
    ...
    def _create_statusbar(self):
        """Create status bar"""
        self.statusbar = ctk.CTkFrame(self, fg_color=THEME.bg_medium, height=26, corner_radius=0)
        ...
        self.language_label.pack(side="right", padx=12, pady=4)
        
        ctk.CTkFrame(right_frame, width=1, height=16, fg_color=THEME.bg_light).pack(side="right", padx=4)
        ...
        self.encoding_label.pack(side="right", padx=8, pady=4)
    ...
    def _create_tab_button(self, tab_id: str):
        ...
        tab_frame = ctk.CTkFrame(self.tab_container, fg_color=THEME.tab_inactive, corner_radius=0, height=32)
        tab_frame.pack(side="left", padx=0, pady=4)
...
class GitHubConfigDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent, settings: EditorSettings):
        ...
        self.path_entry.insert(0, settings.github_path or "notepad_plus_sync")
    ...
    def _load_credentials(self):
        ...
        if filepath:
            try:
                ...
                creds_path = Path.home() / ".notepad_plus_gdrive_credentials.json"
